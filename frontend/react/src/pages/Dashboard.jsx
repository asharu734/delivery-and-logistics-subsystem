...
function Dashboard() {
    ...
    const updateStatus = async (id, status) => {
        try {
            await axios.put(`${DELIVERIES_URI}/${id}`, { status });
            fetchDeliveries();
        } catch (err) {
            alert("Update failed");
        }
                ...
                {view === "dashboard" && (
                    <div style={styles.grid}>
                        ...
                        <Card
                            ...
                            value={inTransit}
                            color="#2196f3"
                            onClick={() => openView("inTransit")}
                        />
                        <Card
                            title="Delivered"
                            value={delivered}
                            color="#4caf50"
                            onClick={() => openView("delivered")}
                        />
                    </div>
                )}
...
const styles = {
    ...
    sidebarSpace: {
        width: "250px", // adjust based on your sidebar
        flexShrink: 0,
    },
